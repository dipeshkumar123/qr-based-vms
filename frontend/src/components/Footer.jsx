    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold">II-VMS</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Intelligent, Integrated Visitor Management System for modern organisations. Secure, fast, and AI-powered.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/" className="text-gray-400 hover:text-white text-sm transition inline-flex items-center gap-1.5">
              ...
              <li>
                <Link to="/register" className="text-gray-400 hover:text-white text-sm transition inline-flex items-center gap-1.5">
              ...
              <li>
                <Link to="/admin/login" className="text-gray-400 hover:text-white text-sm transition inline-flex items-center gap-1.5">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} II-VMS. All rights reserved.</p>
          <p className="text-gray-600 text-xs">Built with React, Node.js & AI</p>
        </div>
      </div>
    </footer>
  );
